...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <form method="post" action="{{ url('admin/update/product/withoutphoto/'.$product->id) }} "
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <form method="post" action="{{ url('admin/update/product/photo/'.$product->id) }} "
                enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <label class="custom-file">
                            <input type="file" class="custom-file-input" name="image_two" onchange="readURL2(this);">
                            <span class="custom-file-control"></span>
