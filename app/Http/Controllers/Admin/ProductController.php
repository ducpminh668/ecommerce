...
class ProductController extends Controller
{
    ...
    public function DeleteProduct($id)
    {
        ...
        try {
            ...
            $notification = array(
                'messege' => 'Link file ảnh không tồn tại',
                'alert-type' => 'error',
            );
        }
    ...
    public function UpdateProductPhoto(Request $request, $id)
    {
        ...
        if ($image_one) {
            ...
            $image_name = date('dmy_H_s_i_');
            $ext = strtolower($image_one->getClientOriginalExtension());
            $image_full_name = $image_name . $image_one->getClientOriginalName();
        ...
        if ($image_two) {
            ...
            $image_full_name = $image_name . $image_two->getClientOriginalName();
            $upload_path = 'media/product/';
            $image_url = $upload_path . $image_full_name;
        ...
        if ($image_three) {
            ...
            $image_full_name = $image_name . $image_three->getClientOriginalName();
            $upload_path = 'media/product/';
            $image_url = $upload_path . $image_full_name;
